  ...
  return (
    <div className='bg-[#12131c] text-white'>
        ...
        <div className='flex justify-center items-center p-8'>
            <img className='mx-4 w-[10%] cursor-pointer' src="https://dev.mecarreira.com/static/media/twitter.7e8d40d4c7aa6e6a0630eec605e4fbb5.svg" alt="" />
            <img className='mx-4 w-[10%] cursor-pointer' src="https://dev.mecarreira.com/static/media/discord.d0c886d55ce65e2a9df3be21336efcc4.svg" alt="" />
            <img className='mx-4 w-[10%] cursor-pointer'src="https://dev.mecarreira.com/static/media/Instagram.02bca3973a3cff15393f0b6855dad961.svg" alt="" />
            <img className='mx-4 w-[10%] cursor-pointer' src="https://dev.mecarreira.com/static/media/youtube.7df565ff5027556a9ec673e790a6e6c1.svg" alt="" />
        </div>
        <div className='bg-[#43444b] w-[50%] h-[1px] mt-4 mb-4 m-[auto]'></div>
