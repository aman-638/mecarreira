        ...
        <div className='flex w-[90%] m-auto md:ml-[40%] sign '>
          ...
          <div className='w-[380px] rounded-xl'>
             ...
             <div className='bg-[#212435] rounded-xl h-[450px] md:h-[500px]'>
                ...
                <p className='text-white font-semibold text-center text-lg mt-8'>We have sent an email to</p>
                <p className='text-white font-semibold text-center text-lg '> your email with a</p>
                <p className='text-white font-semibold text-center text-lg '>verification link.</p>

                <form onSubmit={formSubmit}>
                <p className='text-white font-semibold text-center text-lg mt-8'>Please click on that link to</p>
                 {/* <input type="text" id='id' onChange={changeHandler} className='flex w-[80%] m-auto  p-2 outline-none bg-[#2c2f45] text-[#75716c]' /> */}
                 <p className='text-white font-semibold text-center text-lg '>activate your account.</p>
